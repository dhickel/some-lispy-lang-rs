...
use std::vec;
use lasso::Spur;
use crate::eval2::environment::Environment;
use crate::lang2::datatypes::{ClassData, ClassMetaData, ObjectAccess, StructData};
use crate::lang2::types::Type;
use crate::parse2::ast_nodes::AstNode::LiteralNode;
use crate::parse2::{Lit, Mod};
